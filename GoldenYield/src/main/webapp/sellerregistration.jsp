...
<div class="container">
    <div class="welcome-section">
        ...
        <p>Join our platform and start earning in just 30 seconds!</p>
    ...
    <div class="form-section">
        ...
        <form id="sellerregistration" action="sellerregistrationlink" method="POST">
            <label>Name:</label>
            ...
            <label>Crop in Acres:</label>
            <input type="text" name="crop" required>

            <label>Total Estimated Trees:</label>
            <input type="number" name="trees" required>
            ...
            <input type="number" name="secretId" required>

            <label>Secret Key:</label>
            <input type="text" name="secretkey" required>
...
<script>
    var form = document.getElementById("sellerregistration");
